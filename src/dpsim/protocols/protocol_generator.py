"""Protocol generator engine for dpsim wet-lab protocols.
...
from dpsim.protocols.mechanism_data import get_mechanism
from dpsim.protocols.protocol_document import (
    ProtocolDocument,
    ProtocolStep,
    ReagentRequirement,
)
