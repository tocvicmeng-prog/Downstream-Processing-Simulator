...
class LRMResult:
    ...
    Attributes:
        ...
        C_profile_final: Final axial mobile-phase profile [mol/m^3].
        Cp_profile_final: Final axial particle-pore liquid profile [mol/m^3].
        q_profile_final: Final axial bound-phase profile [mol/m^3].
    """
...
def solve_lrm(
    ...
    return LRMResult(
        ...
        C_profile_final=C_all[:, -1].copy(),
        Cp_profile_final=Cp_all[:, -1].copy(),
        q_profile_final=q_all[:, -1].copy(),
    )
