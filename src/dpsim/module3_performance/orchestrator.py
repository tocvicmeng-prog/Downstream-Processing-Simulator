...
class BreakthroughResult:
    ...
    q_profile_final: np.ndarray | None = None
    C_profile_final: np.ndarray | None = None
    Cp_profile_final: np.ndarray | None = None
...
def run_breakthrough(
    ...
    Args:
        ...
        log_flow_warnings: When True, hydraulic domain warnings are emitted
            through the module logger. Lifecycle orchestration can set this
            False after adding the same checks to its structured validation
            report.
    ...
    return BreakthroughResult(
        ...
        z=lrm_result.z,
        q_profile_final=lrm_result.q_profile_final,
        C_profile_final=lrm_result.C_profile_final,
        Cp_profile_final=lrm_result.Cp_profile_final,
