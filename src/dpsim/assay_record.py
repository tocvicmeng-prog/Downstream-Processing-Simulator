...
class AssayKind(Enum):
    ...
    """Wet/dry or buffer-equilibrated swelling ratio; informs porosity and column-state corrections."""
    ...
    """Single-bead or packed-bed compression curve; informs M3 pressure/compression limits."""

    RESIDUAL_OIL = "residual_oil"
    """TOC, gravimetric, or extraction assay; informs M1 washing carryover."""

    RESIDUAL_SURFACTANT = "residual_surfactant"
    """Colorimetric, HPLC, or MS surfactant assay; informs M1 washing carryover."""
    ...
    PRESSURE_FLOW_CURVE = "pressure_flow_curve"
    """Packed-bed pressure-flow curve; informs M3 hydraulic calibration."""
    ...
    LIGAND_LEACHING = "ligand_leaching"
    """Post-storage or post-CIP ligand loss assay; informs M2 ligand stability."""

    FREE_PROTEIN_WASH_FRACTION = "free_protein_wash_fraction"
    """UV280/ELISA/BCA wash-fraction assay; informs M2 coupling/washing closure."""
