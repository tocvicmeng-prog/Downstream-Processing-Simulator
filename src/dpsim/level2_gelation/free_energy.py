...
Core Flory-Huggins functions are delegated to :mod:`dpsim.properties.thermodynamic`
...
def flory_huggins_mu(phi: np.ndarray, T: float, chi: float,
    ...
    Delegates to :func:`dpsim.properties.thermodynamic.flory_huggins_derivative`.
    """
...
def flory_huggins_d2f(phi: np.ndarray, T: float, chi: float,
    ...
    Delegates to :func:`dpsim.properties.thermodynamic.flory_huggins_second_derivative`.
    """
