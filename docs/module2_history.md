...
> `src/dpsim/module2_functionalization/`. Scientific candidate
...
`src/dpsim/module2_functionalization/reagent_profiles.py`. Each profile
carries:
...
- Current code: `src/dpsim/module2_functionalization/`
