...
`src/dpsim/optimization/engine.py:410` and broader risk of API drift across
...
- **Downstream library compat.** If a future DPSim feature depends on a
...
- `src/dpsim/optimization/engine.py:410` (the duck-typed call site)
