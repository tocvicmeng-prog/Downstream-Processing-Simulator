# Ligand & Protein Coupling Candidates for DPSim Module 2

## Scientific Advisor Literature Screening Report

**Date:** 2026-04-12
**Scope:** Downstream processing publications screened for ligand coupling and protein coupling candidates compatible with DPSim M2's epoxide/vinyl sulfone-activated agarose microspheres.
...
> **Disclaimer**: This scientific analysis is provided for informational, research, and advisory purposes only. All kinetic parameters are order-of-magnitude estimates requiring experimental calibration for the specific material, ligand lot, and assay method before quantitative use.
