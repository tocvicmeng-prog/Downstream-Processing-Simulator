...
| File | Purpose | LOC |
|---|---|---|
| `src/dpsim/digital_twin/__init__.py` | Module exports | ~15 |
| `src/dpsim/digital_twin/schema.py` | `DigitalTwinTrace` dataclass + JSON load/save | ~130 |
| `src/dpsim/digital_twin/enkf.py` | Stochastic EnKF update (single step) | ~180 |
| `src/dpsim/digital_twin/replay.py` | Trace replay harness | ~180 |
