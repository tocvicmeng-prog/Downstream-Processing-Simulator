...
Source: `docs/03_scientific_review.md`. Full review of `src/dpsim/` at v3.0
...
`src/dpsim/module2_functionalization/edc_nhs_kinetics.py`.
...
### A.7  Crosslinker Library — scientific provenance (SA-DPSIM-XL-001)

Source: `docs/SA-DPSIM-XL-001_Crosslinker_Evaluation.md` Rev 1.0
...
SA-DPSIM-XL-002, preserved externally in the v9.2.2 CHANGELOG entry).
...
90 °C emulsification** in DPSim's standard workflow. k_fwd ≈ 1×10⁻⁶
