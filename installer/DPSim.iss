...
; lets `ISCC.exe DPSim.iss` still work when run by hand without the helper.
#ifndef MyAppVersion
#define MyAppVersion    "0.1.0"
#endif
#define MyAppPublisher  "Holocyte Pty Ltd"
#define MyAppURL        "https://github.com/tocvicmeng-prog/Downstream-Processing-Simulator"
...
OutputDir=..\release
OutputBaseFilename=DPSim-{#MyAppVersion}-Setup
SetupIconFile=
...
[Icons]
Name: "{group}\DPSim (Web UI)"; Filename: "{app}\launch_ui.bat"; WorkingDir: "{app}"; Comment: "Launch the DPSim web dashboard"; Tasks: startmenuicon
Name: "{group}\DPSim (Command line)"; Filename: "{app}\launch_cli.bat"; WorkingDir: "{app}"; Comment: "Open a Command Prompt with dpsim on PATH"; Tasks: startmenuicon
...
Name: "{autodesktop}\{#MyAppName} (Web UI)"; Filename: "{app}\launch_ui.bat"; WorkingDir: "{app}"; Comment: "Launch the DPSim web dashboard"; Tasks: desktopicon
  ...
  begin
    ...
    begin
      if MsgBox(
        ...
        'DPSim needs Python to run. You can:' + #13#10 +
