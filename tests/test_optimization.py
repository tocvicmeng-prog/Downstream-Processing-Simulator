...
class TestSearchSpace:
    def test_roundtrip(self):
        ...
        from dpsim.optimization.engine import _to_search_space, _from_search_space
    ...
    def test_log_transforms(self):
        from dpsim.optimization.engine import _to_search_space
        x = np.array([10000, 20, 0.7, 363, 0.167, 2.0, 86400.0])
        x_ss = _to_search_space(x)
...
class TestOptimizationEngine:
    ...
    def test_evaluate_uses_trust_aware_objectives(self, monkeypatch):
        from dpsim.optimization import engine as opt_engine
        from dpsim.optimization.engine import OptimizationEngine
...
class TestNode6TrustPenalty:
    ...
    def test_penalty_ordering(self):
        ...
        from dpsim.optimization.objectives import trust_penalty_for_tier
    ...
    def test_qualitative_tier_excluded_from_pareto(self):
        ...
        from dpsim.optimization.objectives import compute_objectives_trust_aware
