...
from dpsim.datatypes import MaterialProperties, SimulationParameters
from dpsim.level2_gelation.spatial import (
    create_radial_grid, build_laplacian_matrix,
    create_2d_grid, build_laplacian_2d, build_mobility_laplacian_2d,
)
from dpsim.level2_gelation.free_energy import (
    flory_huggins_mu, flory_huggins_d2f, contractive_constant,
)
from dpsim.level2_gelation.gelation import (
    avrami_gelation, gelation_rate_constant, cooling_temperature, mobility,
)
from dpsim.level2_gelation.pore_analysis import (
...
class TestCahnHilliardSolver:
    def test_solver_runs(self):
        ...
        from dpsim.level2_gelation.solver import CahnHilliardSolver
...
class TestCahnHilliard2DSolver:
    ...
    def test_2d_solver_runs(self):
        ...
        from dpsim.level2_gelation.solver import CahnHilliard2DSolver
    ...
    def test_solve_gelation_ch_2d_mode(self):
        ...
        from dpsim.level2_gelation.solver import solve_gelation
        params = SimulationParameters()
...
class TestNode8AlphaFromTiming:
    ...
    def test_legacy_no_timing_keeps_hardcoded(self):
        from dpsim.level2_gelation.solver import solve_gelation_empirical
        params = SimulationParameters()
        props = MaterialProperties()
    ...
    def test_timing_drives_alpha_and_diagnostics(self):
        from dpsim.datatypes import GelationTimingResult
        from dpsim.level2_gelation.solver import solve_gelation_empirical
        params = SimulationParameters()
        props = MaterialProperties()
