...
Plus Phase 2c wiring:
  ...
  - CLI ``--polymer-family`` flag on ``dpsim run``
"""
...
from dpsim.level2_gelation.ionic_ca import solve_ionic_ca_gelation
...
class TestCliPolymerFamilyFlag:
    def test_run_subparser_accepts_alginate_choice(self):
        """argparse should accept ``dpsim run --polymer-family alginate``."""
        import argparse
        from dpsim.__main__ import main as cli_main  # noqa: F401
        ...
        parser = argparse.ArgumentParser(prog="dpsim")
