...
from dpsim.properties.cellulose_defaults import (
...
class TestPresetDiagnosticsDifferentiate:
    def test_switching_preset_changes_l4_manifest_diagnostics(self):
        ...
        """
        from dpsim.level2_gelation.nips_cellulose import solve_nips_cellulose
        from dpsim.level4_mechanical.cellulose import (
