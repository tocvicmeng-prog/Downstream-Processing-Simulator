...
class TestCalibrationIntegration:
    ...
    def test_apply_calibration_overrides_fmc(self):
        ...
        from dpsim.module2_functionalization.orchestrator import build_functional_media_contract
    ...
    def test_load_json_from_file(self, tmp_path):
        ...
        from dpsim.calibration import CalibrationStore
...
class TestLifetimeIntegration:
    ...
    def test_protein_a_typical_lifetime(self):
        ...
        from dpsim.lifetime import project_lifetime
...
class TestM2CalibrationM3Pipeline:
    ...
    def test_isotherm_selection_from_fmc(self):
        ...
        from dpsim.module2_functionalization.orchestrator import build_functional_media_contract
        from dpsim.module3_performance.isotherms.adapter import select_isotherm_from_fmc
