...
Scientific basis: SA-DPSIM-XL-002 Rev 0.1 + Seal BL (1996) Biomaterials
...
from dpsim.level3_crosslinking.solver import solve_crosslinking
from dpsim.reagent_library import CROSSLINKERS, NH2CoReaction
...
class TestPhosphoramideKineticsFirstPrinciples:
    ...
    def test_nh2_rate_increases_with_temperature(self):
        from dpsim.level3_crosslinking.solver import arrhenius_rate_constant
        nh2 = CROSSLINKERS["stmp"].nh2_co_reaction
        assert nh2 is not None
