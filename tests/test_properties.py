...
from dpsim.properties.interfacial import interfacial_tension_span80, sigma_bare
from dpsim.properties.thermodynamic import (
    chi_flory_huggins,
    flory_huggins_second_derivative,
    mesh_size_canal_peppas,
    spinodal_boundary,
)
from dpsim.properties.viscosity import (
