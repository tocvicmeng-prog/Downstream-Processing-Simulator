...
class TestM1AdaptiveExtension:
    ...
    def _make_props(self):
        from dpsim.datatypes import MaterialProperties
...
class TestM2CrosslinkerStoichiometry:
    ...
    def test_recommended_concentration_known_value(self):
        ...
        from dpsim.level3_crosslinking.solver import recommended_crosslinker_concentration
    ...
    def test_default_ratio_above_threshold(self):
        ...
        from dpsim.datatypes import SimulationParameters, MaterialProperties
...
class TestM3HashinShtrikmanBounds:
    ...
    def test_hs_bounds_symmetric_equal_moduli(self):
        ...
        from dpsim.level4_mechanical.solver import hashin_shtrikman_bounds
        G = 10000.0
...
class TestM3FloryRehner:
    ...
    def test_physical_phi_eq_in_unit_interval(self):
        ...
        from dpsim.level4_mechanical.solver import flory_rehner_swelling
...
class TestM3AffineIPN:
    ...
    def test_affine_single_network_no_chitosan(self):
        ...
        from dpsim.level4_mechanical.solver import double_network_modulus_affine
...
class TestM3SelectModulusModel:
    ...
    def _make_crosslinking_result(self, nu_e_final=1e20):
        ...
        from dpsim.datatypes import CrosslinkingResult
        import numpy as np
    ...
    def test_mechanistic_mode_uses_affine(self):
        ...
        """
        from dpsim.level4_mechanical.solver import select_modulus_model
        from dpsim.datatypes import SimulationParameters, NetworkTypeMetadata, ModelMode
    ...
    def test_hybrid_coupled_uses_phenomenological(self):
        ...
        from dpsim.level4_mechanical.solver import select_modulus_model
        from dpsim.datatypes import NetworkTypeMetadata
...
class TestM4PerChemistryEta:
    ...
    def test_genipin_eta_backward_compatible(self):
        ...
        from dpsim.level4_mechanical.solver import double_network_modulus
...
class TestDatatypeFields:
    ...
    def test_solver_settings_has_l1_adaptive_fields(self):
        ...
        from dpsim.datatypes import SolverSettings
        s = SolverSettings()
    ...
    def test_mechanical_result_has_hs_bounds(self):
        ...
        from dpsim.datatypes import MechanicalResult
        import numpy as np
        r = MechanicalResult(
