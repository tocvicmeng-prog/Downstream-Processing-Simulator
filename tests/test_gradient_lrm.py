...
from dpsim.module3_performance.isotherms.imac import IMACCompetitionIsotherm
from dpsim.module3_performance.isotherms.adapter import EquilibriumAdapter
from dpsim.module3_performance.process_state import ProcessState
from dpsim.module3_performance.transport.lumped_rate import solve_lrm
from dpsim.module3_performance.gradient import (
...
class TestGradientSensitiveProperty:
    ...
    def test_protein_a_gradient_sensitive(self):
        from dpsim.module3_performance.isotherms.protein_a import ProteinAIsotherm
        iso = ProteinAIsotherm()
        assert iso.gradient_sensitive is True
        assert iso.gradient_field == "ph"

    def test_competitive_affinity_gradient_sensitive(self):
        from dpsim.module3_performance.isotherms.competitive_affinity import CompetitiveAffinityIsotherm
    ...
    def test_competitive_langmuir_not_sensitive(self):
        from dpsim.module3_performance.isotherms.competitive_langmuir import CompetitiveLangmuirIsotherm
