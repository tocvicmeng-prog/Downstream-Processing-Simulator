...
from dpsim.level1_emulsification.thermal import (
    cooling_time_constant, temperature_profile,
)
from dpsim.level1_emulsification.energy import (
...
class TestV2ModelMode:
    ...
    def test_default_mode(self):
        from dpsim.datatypes import SimulationParameters, ModelMode
...
class TestBeadRadiusFix:
    ...
    def test_solve_mechanical_accepts_R_droplet(self):
        from dpsim.level4_mechanical.solver import solve_mechanical
        import inspect
