...
from dpsim.module3_performance.catalysis.kinetics import (
    michaelis_menten_rate,
    thiele_modulus,
    effectiveness_factor,
    generalized_thiele_modulus,
)
from dpsim.module3_performance.catalysis.deactivation import (
    first_order_deactivation,
    half_life,
    arrhenius_deactivation_rate,
)
from dpsim.module3_performance.catalysis.packed_bed import (
    CatalyticResult,
    solve_packed_bed,
)
